                                ...
                                if (acBarrio.getText().toString().indexOf(" - ") > 0) {
                                    ...
                                    if (!acBarrio2.getText().toString().equals("")) {
                                        ...
                                        if (acBarrio2.getText().toString().indexOf(" - ") > 0) {
                                            ...
                                            String[] fechaReg = etFecha.getText().toString().split("-");
                                            String[] fechaEnt = etFecha2.getText().toString().split("-");
                                            ...
                                            if (anioE > anioR && mesE > mesR && diaE > diaR) {
                                                ...
                                                Toast toast1 =
                                                        Toast.makeText(this, "La fecha para recibir el pedido no puede ser menor a la de entrega", Toast.LENGTH_LONG);
